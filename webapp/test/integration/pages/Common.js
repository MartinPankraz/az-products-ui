sap.ui.define([
	...
	return Opa5.extend("my.azure.productsui.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["my/azure/productsui/localService/mockserver"], function (mockserver) {
