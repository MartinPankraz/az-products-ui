		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "S4 on Azure via Private Link",
									"targetURL": "#S4onAzureviaPrivateLink-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"S4onAzureviaPrivateLink-display": {
								"semanticObject": "S4onAzureviaPrivateLink",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=my.azure.productsui",
									"url": sap.ui.require.toUrl("my/azure/productsui")
								}
							}
						}
					}
